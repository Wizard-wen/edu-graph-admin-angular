...
@Component({
  ...
  templateUrl: './domain.config.dialog.component.html',
  styleUrls: ['./domain.config.dialog.component.scss']
})
export class DomainConfigDialogComponent implements OnInit {
  @Input()
  id?: string;
